...
//                 List<String> currentLiveCode = newOne.getMethodLiveCodeString(current.getSignature());
     ...
     public static void main (String[]args) throws IOException {
        ...
        //          "dependencies/asm-3.1.jar"+cpSeparator+"/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar", "");
        //  process("avrora.Main", 3000,
        //          new String[]{"-action=cfg","./sootOutput/avrora-cvs-20091224/example.asm"},
        //          "./sootOutput/avrora-cvs-20091224/","/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar", "");
        // process("org.apache.batik.apps.rasterizer.Main", 400,null,
        //         "./sootOutput/batik-all/","/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar", "");
         process("org.eclipse.core.runtime.adaptor.EclipseStarter",20000,
                 new String[]{"-debug"}, "./sootOutput/eclipse/", "/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar", "");
         process("org.sunflow.Benchmark", 5,
                 new String[]{"-bench","2","256"},
                 "./sootOutput/sunflow-0.07.2/",
                 "dependencies/janino-2.5.15.jar"+cpSeparator+"/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar", "");
         process("org.apache.fop.cli.Main", 3000,
                 ...
                 "dependencies/xmlgraphics-commons-1.3.1.jar" + cpSeparator +
                         ...
                         "dependencies/commons-io-1.3.1.jar"+cpSeparator+"/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar", "");
        process("net.sourceforge.pmd.PMD", 50,
                ...
                "dependencies/jaxen-1.1.1.jar" + cpSeparator +
                        "dependencies/asm-3.1.jar"+cpSeparator+"/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar", "");
         process("Test",5,new String[]{},"./sootOutput/test/","/usr/local/java/jdk1.8.0_301/jre/lib/rt.jar","");
